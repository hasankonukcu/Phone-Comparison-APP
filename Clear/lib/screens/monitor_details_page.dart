...
class MonitorDetailsPage extends StatefulWidget {
  ...
  @override
  State<MonitorDetailsPage> createState() => _DetailsPageState();
}

class _DetailsPageState extends State<MonitorDetailsPage> {
  var _allDetails;
  var _phone;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][1]['BAĞLANTILAR']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][1]['BAĞLANTILAR']
                              .length,
                          shrinkWrap: true,
                        ),
                        const Center(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][2]['STANT'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount:
                              _allDetails['ozellikler'][2]['STANT'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][3]
                                    ['TASARIM & BOYUTLAR'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][3]
                                  ['TASARIM & BOYUTLAR']
                              .length,
                          shrinkWrap: true,
                        ),
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][4]['GÜÇ'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][4]['GÜÇ'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][5]['GENEL ÖZELLİKLER']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
