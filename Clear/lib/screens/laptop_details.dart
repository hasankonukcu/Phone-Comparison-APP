...
class LaptopDetailsPage extends StatefulWidget {
  ...
  @override
  State<LaptopDetailsPage> createState() => _DetailsPageState();
}

class _DetailsPageState extends State<LaptopDetailsPage> {
  var _allDetails;
  var _phone;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][0]['GENEL BİLGİLER']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][0]
                                  ['GENEL BİLGİLER']
                              .length,
                          shrinkWrap: true,
                        ),
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][1]['EKRAN'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount:
                              _allDetails['ozellikler'][1]['EKRAN'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][2]['TASARIM'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount:
                              _allDetails['ozellikler'][2]['TASARIM'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][3]['İŞLEMCİ'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount:
                              _allDetails['ozellikler'][3]['İŞLEMCİ'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][4]['BELLEK'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount:
                              _allDetails['ozellikler'][4]['BELLEK'].length,
                          shrinkWrap: true,
                        ),
                        const Center(
                            child: Row(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][6]['HARİCİ GRAFİK']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][7]
                                    ['BAĞLANTILAR & ARAYÜZLER'][index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][8]['PİL & DİĞER']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][8]['PİL & DİĞER']
                              .length,
                          shrinkWrap: true,
                        ),
                        const Center(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Map<String, dynamic> text =
                                _allDetails['ozellikler'][9]['DAHİLİ GRAFİK']
                                    [index];
                            return showListItem(
                                text.keys.first, text.values.first, width);
                          },
                          itemCount: _allDetails['ozellikler'][9]
                                  ['DAHİLİ GRAFİK']
                              .length,
                          shrinkWrap: true,
                        ),
