import 'dart:convert';
import 'package:compare_app/custom_app_bar_laptop.dart';
import 'package:compare_app/screens/compare_page.dart';
import 'package:compare_app/models/phone_model.dart';
import 'package:compare_app/screens/laptop_details.dart';
...
class _LaptopPageState extends State<LaptopPage> {
  List<Map<String, dynamic>> brandList = [
    ...
    {"title": "Monster", "isCheck": false},
    {"title": "MSI", "isCheck": false},
    {"title": "Apple", "isCheck": false},
    {"title": "Acer", "isCheck": false},
    {"title": "Casper", "isCheck": false},
    {"title": "Dynabook", "isCheck": false},
    {"title": "Everest", "isCheck": false},
    {"title": "EXA", "isCheck": false},
    {"title": "Fujitsu", "isCheck": false},
    {"title": "Game Garaj", "isCheck": false},
    {"title": "Gigabyte", "isCheck": false},
    {"title": "Hometech", "isCheck": false},
    {"title": "Honor", "isCheck": false},
    {"title": "Huawei", "isCheck": false},
    {"title": "I-Life", "isCheck": false},
    {"title": "Ixtech" "Mobile", "isCheck": false},
              ...
              ? SingleChildScrollView(
                  ...
                  child: SafeArea(
                    ...
                    children: [
                      FadeAnimation(
                        delay: 0.5,
                        child: CustomAppBarLaptop(user: _userModel.user),
                      ),
  ...
  getPhones() async {
    try {
      ...
      List<Phones> _dreams = await _userModel.getAllLaptopPagination(
