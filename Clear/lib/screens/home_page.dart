...
import 'package:compare_app/widgets/catagories.dart';
import 'package:compare_app/widgets/custom_app_bar.dart';
import 'package:compare_app/widgets/phone_header.dart';
...
class _HomePageState extends State<HomePage> {
  List<Map<String, dynamic>> brandList = [
    {"title": "OnePlus", "isCheck": false},
    {"title": "Xiaomi", "isCheck": false},
    {"title": "HTC", "isCheck": false},
    {"title": "Huawei", "isCheck": false},
    {"title": "Asus", "isCheck": false},
    {"title": "Samsung", "isCheck": false},
    {"title": "Apple", "isCheck": false},
    {"title": "Honor", "isCheck": false},
    {"title": "UmiDigi", "isCheck": false},
    {"title": "ZTE", "isCheck": false},
    {"title": "Meizu", "isCheck": false},
    {"title": "Poco", "isCheck": false},
    {"title": "LG", "isCheck": false},
    {"title": "Oppo", "isCheck": false},
    {"title": "realme", "isCheck": false},
    {"title": "TCL", "isCheck": false},
    {"title": "Vestel", "isCheck": false},
    {"title": "HP", "isCheck": false},
    {"title": "Casper", "isCheck": false},
    {"title": "General" "Mobile", "isCheck": false},
    {"title": "Vivo", "isCheck": false},
    {"title": "Infinix", "isCheck": false},
    {"title": "Tecno", "isCheck": false},
    {"title": "Omix", "isCheck": false},
    {"title": "Sony", "isCheck": false},
    {"title": "Nokia", "isCheck": false},
  ];
              ...
              ? SingleChildScrollView(
                  ...
                  child: SafeArea(
                    ...
                    children: [
                      FadeAnimation(
                        delay: 0.5,
                        child: CustomAppBar(user: _userModel.user),
                      ),
                                  ...
                                  child: Container(
                                    ...
                                    child: StaggeredGrid.count(
                                      ...
                                      children: _allPhones!.map<Widget>((item) {
                                        ...
                                        String decoded =
                                            stringToBase64.decode(image);
                                        String decoded2 =
                                            stringToBase64.decode(decoded);
  ...
  getPhones() async {
    try {
      ...
      List<Phones> _dreams = await _userModel.getAllPhonesPagination(
